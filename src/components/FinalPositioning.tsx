        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="bg-gradient-glass backdrop-blur-xl rounded-3xl p-10 border border-neonCyan/30 shadow-neon relative overflow-hidden">
            ...
            <div className="relative text-center max-w-2xl mx-auto">
              <h3 className="text-2xl md:text-3xl font-bold mb-4 tracking-tight">Explore uma oportunidade de mercado em rápido crescimento</h3>
              <p className="text-muted-foreground/90 mb-6 leading-relaxed">
                É uma solução produtiva e escalável, que permite aos Parceiros apoiar mais clientes sem aumentar equipas ou processos.
              </p>
